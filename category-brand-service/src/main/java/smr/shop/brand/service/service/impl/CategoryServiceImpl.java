...
import smr.shop.brand.service.messaging.publisher.CategoryDeleteMessagePublisher;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public CategoryGrpcResponse getCategoryInformation(CategoryGrpcRequest request) {
        CategoryEntity categoryEntity = findById(request.getCategoryId());
