...
import smr.shop.ticket.service.dto.ticketMessage.request.UpdateTicketMessageRequest;
...
public class TicketMessageMapperImpl implements TicketMessageMapper {
    ...
    @Override
    public void mapForUpdate(TicketMessage ticketMessage, UpdateTicketMessageRequest request) {
        if (request.getMessage() != null)
            ticketMessage.setMessage(request.getMessage());
        if (request.getTicketId() != null)
            ticketMessage.setTicketId(request.getTicketId());
        if (request.getUserId() != null)
            ticketMessage.setUserId(request.getUserId());
    }
}